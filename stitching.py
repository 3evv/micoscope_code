...
===========================
python stitching.py "undistortedleft.jpg" "undistortedright.jpg" --conf_thresh 0.6 --compose_megapix 0.6 --matcher affine --matcher affine --ba_refine_mask xxxxx --wave_correct horiz
...
parser.add_argument(
    '--compose_megapix', action='store', default=0.6,
...
def stitch(acceptor_img, donor_img, conf_thresh = 0.3):
    ...
    images_array = (acceptor_img, donor_img)
    ...
    for idx, name in enumerate(images_array): 
        full_img = images_array[idx]
...
if __name__ == '__main__':
    ...
    Left1x=cv.imread("data/Left.jpg") 
    Right1x=cv.imread("data/Right.jpg") 
    stitch(Left1x,Right1x)
